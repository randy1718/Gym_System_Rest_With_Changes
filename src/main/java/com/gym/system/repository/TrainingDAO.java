...
public class TrainingDAO {
    ...
    public List<Training> findTrainingsByTraineeUsername(String username, String fromDate, String toDate, String trainerName, String trainingType){
    ...
    public List<Training> findTrainingsByTrainerUsername(String username, String fromDate, String toDate, String traineeName, String trainingType){
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
        LocalDateTime formattedFromDate = LocalDateTime.parse(fromDate, formatter);
        LocalDateTime formattedToDate = LocalDateTime.parse(toDate, formatter);
        return em.createQuery(
